<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="password" class="block mt-1 w-full border-primary-500 "
                            type="password"
                            name="password"
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded border-gray-300 text-indigo-600 custom-box-shadow focus:ring-indigo-500" name="remember">
