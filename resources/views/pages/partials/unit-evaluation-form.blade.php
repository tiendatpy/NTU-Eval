      ...
      <div>
        ...
        <div class="mb-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div class="col-span-1">
            ...
            <select disabled class="border-gray-300 border rounded-lg p-2.5 w-full focus:border-primary-500 focus:ring focus:ring-primary-200 focus:ring-opacity-50 transition-all" id="quality_id" name="quality_id" required>
          ...
          <div class="mb-6 col-span-2">
            ...
            <textarea disabled id="evidence" name="evidence" class="ckeditor w-full border-gray-300 rounded-lg">{{ $unitEvaluation ? $unitEvaluation->evidence : '' }}</textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div class="col-span-1">
            <div class="mb-6">
              ...
              <select disabled class="border-gray-300 border rounded-lg p-2.5 w-full focus:border-primary-500 focus:ring focus:ring-primary-200 focus:ring-opacity-50 transition-all" id="title_id" name="title_id" required>
            ...
            <div>
              ...
              <select disabled class="border-gray-300 border rounded-lg p-2.5 w-full focus:border-primary-500 focus:ring focus:ring-primary-200 focus:ring-opacity-50 transition-all" id="reward_id" name="reward_id" required>
          ...
          <div class="mb-6 col-span-2">
            ...
            <textarea disabled id="achievement" name="achievement" class="ckeditor w-full border-gray-300 rounded-lg" required>{{ $unitEvaluation ? $unitEvaluation->achievement : '' }}</textarea>
        ...
        <div class="text-right border-t border-gray-200 pt-5">
          <button type="submit" class="btn btn-primary cursor-not-allowed bg-states-500/70 hover:bg-states-500/70" disabled>
          Cập nhật đánh giá
          </button>
        </div>
      </div>
